 ...
 * DATABASE TEMPLATE
 * 
 * Standard database configuration structure for API files.
 * This version uses hardcoded configuration values (no external config loader).
 * 
 * USAGE:
 * 1. Copy this file and rename it to your specific API file
 * 2. Edit the hardcoded credentials and secrets below
...
function project_secret() {
    ...
    return 'change-this-secret-key-for-your-project';
}
